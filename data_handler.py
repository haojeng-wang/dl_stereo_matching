...
#           SET SEED BEFORE CALLING THIS FUNCTION   
        ...
        # self.val_label = np.full((num_val_loc, 1), self.half_range)
...
if __name__ == '__main__':
    dh = Data_handler(data_version='kitti2012', data_root=os.path.expanduser('~/scratch/algolux/training'),  
        util_root=os.path.expanduser('~/scratch/algolux/cvpr16_stereo_public/preprocess/debug_12'), num_tr_img=160, 
